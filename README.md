# Desafio Extra - Stage 02

![preview](./.github/preview.png)

> Explorer

Desafio realizado no Stage 02 do curso **Explorer** da Rocketseat. <br><br>


## O desafio:
Recriar uma aplicação, a partir de um layout pronto no Figma, para fortalecer alguns conceitos aprendidos nas aula, entre eles: 
<br>
